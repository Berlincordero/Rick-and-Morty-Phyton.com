...
en este caso son tipo character'''
...
#se usa SHIFT+ALT+FLECHA ABAJO.

# para imprimir cada linea se debe utilizar (PRINT) con () donde colocaremos 
#las lineas que deseamos imprimir.

print('') # para dejar un espacio en blanco se utiliza ''
print(line01)
print(line02)
print(line03)
print(line04)
